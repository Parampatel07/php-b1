...
<div class="sidebar-wrapper" data-simplebar="true">
			<div class="sidebar-header">
				<div>
					<img src="theme/codervent.com/rocker/demo/vertical/assets/images/logo-icon.png" class="logo-icon" alt="logo icon">
				</div>
				<div>
					<h4 class="logo-text">Branch </h4>
				</div>
					...
					<div class="user-box dropdown ">
						<a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							...
							<div class="user-info ps-3">
								...
								<p class="designattion mb-0">Name of branch</p>
							</div>
						</a>
						<ul class="dropdown-menu dropdown-menu-end">
							<li><a class="dropdown-item" href="branch_change_password.php"><i class="bx bx-cog"></i><span>Change Password</span></a>
							</li>
